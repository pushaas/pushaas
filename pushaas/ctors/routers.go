...
func NewGinRouter(
	...
	v1InstanceRouter apiV1.InstanceRouter,
...
func NewInstanceRouter(instanceService services.InstanceService, planService services.PlanService) apiV1.InstanceRouter {
